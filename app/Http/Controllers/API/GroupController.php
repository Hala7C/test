...
use App\Repositories\Groups\GroupModelRepository;
...
{
    private GroupModelRepository $group_repository;
    public function __construct(GroupModelRepository $group_repository)
    {
